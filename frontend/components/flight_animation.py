...
def render_airplane_flight_animation(origin: str, destination: str, duration_days: int = 1, group_size: int = 1, budget_str: str = ""):
    ...
    Features:
    - Illustrated earth globe with landmasses and location pins (Origin & Destination)
    - Dashed swirling flight trajectory path wrapping around the globe
    - Sleek modern passenger jet (white fuselage, blue wings, engines) flying smoothly from left to right
    - Drifting white clouds in a sky-blue backdrop
    - Departure & Destination badges with trip telemetry
    """
    animation_html = f"""
    <div class="globe-flight-showcase">
        ...
        <div class="sky-canvas">
            ...
            <div class="globe-stage">
                <!-- Orbit Swirl Lines (Behind and In Front of Globe) -->
                <svg class="orbit-trails-svg" viewBox="0 0 500 320" preserveAspectRatio="xMidYMid meet">
                    ...
                    <!-- Mid-to-Upper orbit ascending loop -->
                ...
                <div class="earth-sphere">
                    <div class="globe-ocean">
                        <!-- Landmass continents SVG -->
                        <svg class="continents-svg" viewBox="0 0 240 240">
                            <!-- Continents in matching illustration pastel cyan/blue -->
                    ...
                    <!-- Origin Map Pin (Left on Globe) -->
                    <div class="globe-pin origin-pin" title="Departure: {origin}">
                        <div class="pin-head">
                            <div class="pin-dot"></div>
                        </div>
                        <div class="pin-tooltip">🛫 {origin}</div>
                    </div>

                    <!-- Destination Map Pin (Right on Globe) -->
                    <div class="globe-pin dest-pin" title="Destination: {destination}">
                        <div class="pin-head dest-color">
                            <div class="pin-dot"></div>
                        </div>
                        <div class="pin-tooltip">🛬 {destination}</div>
                    </div>

                    <!-- Waypoint Pin (Bottom Center on Globe) -->
                ...
                <div class="flying-jet-container">
                    <div class="jet-motion-wrapper">
                        <!-- Trailing Contrail Smoke -->
                        <div class="jet-contrail"></div>
                        
                        <!-- High Quality Vector Aeroplane Matching the Illustration -->
            ...
            <div class="flight-route-strip">
                <div class="route-badge departure-badge">
                    ...
                    <div>
                        ...
                        <div class="badge-city">{origin}</div>
                    </div>
                </div>
                ...
                <div class="route-badge arrival-badge">
                    ...
                    <div>
                        ...
                        <div class="badge-city">{destination}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <style>
        .globe-flight-showcase {{
            ...
            border-radius: 28px;
            overflow: hidden;
            box-shadow: 0 16px 40px -10px rgba(71, 140, 204, 0.35), 0 0 0 1.5px rgba(255, 255, 255, 0.8) inset;
            background: #ffffff;
            position: relative;
        ...
        .jet-motion-wrapper {{
            ...
            width: 170px;
            height: 90px;
            animation: planeFlightFlyby 8s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite;
        }}

        .modern-airliner-svg {{
            width: 100%;
            height: 100%;
            filter: drop-shadow(0 15px 18px rgba(15, 45, 80, 0.3));
        }}
        ...
        @keyframes contrailFade {{
            0% {{ opacity: 0.6; width: 45px; }}
            100% {{ opacity: 1.0; width: 75px; }}
        }}
        ...
        @media (max-width: 680px) {{
            ...
            .jet-motion-wrapper {{ width: 130px; height: 70px; }}
        }}
    </style>
    """
